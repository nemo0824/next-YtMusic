  ...
  return (
    <article className='flex flex-row gap-4 h-[48px] w-full items-center relative group'>
        <div className='w-[48px] h-[48px] relative'>
            ...
            <section className='hidden group-hover:flex absolute top-0 left-0 w-[48px] h-[48px] items-center justify-center bg-black cursor-pointer'>
        ...
        <section className='hidden group-hover:flex absolute top-0 right-0  flex-row h-[48px] justify-end items-center w-[120px] bg-[rgba(0,0,0,0.7)]'>
